...
var BuildingBuilderComponent = (function () {
    ...
    BuildingBuilderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.backendService.getAllBuilding().subscribe(function (buildings) {
...
var BuildingSlotsComponent = (function () {
    ...
    BuildingSlotsComponent.prototype.ngOnInit = function () {
        ...
        this.builder.onBuild().subscribe(function (builder) {
        ...
        this.progressService.onComplete().subscribe(function (builder) {
            if (builder.type === __WEBPACK_IMPORTED_MODULE_5__shared_builder_type_enum__["a" /* BuilderType */].BULDING) {
    ...
    BuildingSlotsComponent.prototype.onBuildingCompleted = function () {
...
var PlanetDetailsComponent = (function () {
    function PlanetDetailsComponent() {
    }
...
var UnitBuilderComponent = (function () {
    ...
    UnitBuilderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.builderService.onSelectedBuilding().subscribe(function (building) {
            _this.visible = true;
            _this.backendService.getAllShips().subscribe(function (data) {
...
var SolarSystemComponent = (function () {
    function SolarSystemComponent(route, router, backendService, routedData, renderer) {
        this.route = route;
        this.router = router;
        this.backendService = backendService;
        this.routedData = routedData;
...
/***/ "../../../../../src/assets/imgs/header_old.png":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "header_old.23668bbf9de700464989.png";
